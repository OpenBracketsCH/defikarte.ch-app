...
const resources = {
  en: {
    translation: {
      ...
      access_permissive_text: 'The owner tolerates public use. However, the owner can revoke permission or tolerance at any time.',
  ...
  de: {
    ...
    fr: {
      translation: {
        ...
        access_permissive_text:
          "Le propriétaire tolère l'utilisation publique. Cependant, le propriétaire peut révoquer l'autorisation ou la tolérance à tout moment.",
        ...
        placeholder_level: '0',
        placeholder_location: "Ecole Zurich Ouest, à côté de l'entrée",
      ...
      it: {
        translation: {
          ...
          placeholder_level: '0',
          placeholder_location: "Scuola di Zurigo Ovest, accanto all'ingresso",
